...
$libModules = @(
    ...
    @{ Name = 'report_desk_sp_anticheat'; File = 'report_desk_sp_anticheat.lua' },
    @{ Name = 'report_desk_sp_anticheat_ui'; File = 'report_desk_sp_anticheat_ui.lua' },
    @{ Name = 'report_desk_spectate_camera'; File = 'report_desk_spectate_camera.lua' },
    @{ Name = 'report_desk_sp_menu_td_block'; File = 'report_desk_sp_menu_td_block.lua' },
    @{ Name = 'report_desk_sp_td_router'; File = 'report_desk_sp_td_router.lua' },
    ...
    @{ Name = 'report_desk_sp_stats_ctx'; File = 'report_desk_sp_stats_ctx.lua' },
...
$allBundleInputs = @(
    ...
    'report_desk_sp_anticheat.lua',
    'report_desk_sp_anticheat_ui.lua',
    'report_desk_spectate_camera.lua',
    'report_desk_sp_menu_td_block.lua',
    'report_desk_sp_td_router.lua',
